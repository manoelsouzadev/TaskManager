package br.edu.ifsp.scl.moviesmanager.ui.update
...
import br.edu.ifsp.scl.moviesmanager.databinding.FragmentUpdateBinding
    ...
    override fun onCreateView(
        ...
        binding.apply {
            ...
            btnUpdate.setOnClickListener() {
                ...
                val task_str = updateEdtTask.text.toString()
